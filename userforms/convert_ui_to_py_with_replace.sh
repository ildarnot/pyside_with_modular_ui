...
# Путь к исходному ui-файлу и выходному py-файлу main_single_window_userform
UI_FILE0="main_single_window_userform.ui"
PY_FILE0="main_single_window_userform.py"
...
echo "1. Преобразование |Главное окно (одиночное)| main_single_window_userform.ui успешно выполнено!"

# Путь к исходному ui-файлу и выходному py-файлу selection_window_userform
UI_FILE1="selection_window_userform.ui"
PY_FILE1="selection_window_userform.py"
# Генерация py-кода из ui-файла
pyside6-uic "$UI_FILE1" -o "$PY_FILE1"
# Добавляем строку после всех строк import
...
# Путь к исходному ui-файлу и выходному py-файлу added_calculation_window_userform
UI_FILE3="added_calculation_window_userform.ui"
PY_FILE3="added_calculation_window_userform.py"
# Генерация py-кода из ui-файла
pyside6-uic "$UI_FILE3" -o "$PY_FILE3"
# Добавляем строку после всех строк import
sed -i '/^    QToolButton, QVBoxLayout, QWidget)/a \
\n\
class CustomDoubleSpinbox(QDoubleSpinBox):\n\    def validate(self, text: str, pos: int) -> tuple[int, str, int]:\n\        text = text.replace(".", ",")\n\        return super().validate(text, pos)\n\    def valueFromText(self, text: str) -> float:\n\        text = text.replace(",", ".")\n\        return float(text)\n\    \n\QDoubleSpinBox=CustomDoubleSpinbox # Ваш дополнительный код здесь!' "$PY_FILE3"
echo "4. Преобразование |Дополнительный расчёт| added_calculation_window_userform.ui успешно выполнено!"